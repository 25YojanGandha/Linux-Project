...
function BodyContainer() {
  ...
  return (
    <div className='BodyContainer'>
      ...
      {gData.isGallery.appOpend ? <Modal data={{ innerData: 'Gallery' }} /> : ''}
      {gData.isCamera.appOpend ? <Modal data={{ innerData: 'Camera' }} /> : ''}
      {gData.isSettings.appOpend ? <Modal data={{ innerData: 'Settings' }} /> : ''}
      {gData.isMeet.appOpend ? <Modal data={{ innerData: 'Meet' }} /> : ''}
      {gData.isNotepad.appOpend ? <Modal data={{ innerData: 'Notepad' }} /> : ''}
      ...
      {gData.isMessage.appOpend ? <Modal data={{ innerData: 'Message' }} /> : ''}
